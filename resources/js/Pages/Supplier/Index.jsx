              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 table-fixed">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                  <tr>
                    ...
                    <th scope="col" className="px-16 py-3">Contrat</th>
                    <th scope="col" className="px-8 py-3">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {suppliers.data
                    ...
                    .map(supplier => (
                      ...
                      >
                        ...
                        <td className="px-3 py-4">{supplier.contact}</td>
                        <td className="px-1 py-4">{supplier.email}</td>
                        <td className="px-20 py-4">{supplier.contrat}</td>
